/* ==========================================================================
   ...
   Run:  node .zscripts/scope-css.mjs
   ========================================================================== */
...
const SRC = resolve(ROOT, 'Layouts/assets');
...
let bundle =
  ...
  '   GENERATED by .zscripts/scope-css.mjs — do not edit by hand.\n' +
  '   Source: Layouts/assets (css/*, sass/style.css); images/fonts: public/mu/\n' +
